...
class CombatScene:
    ...
    def render(self, screen: pygame.Surface, sw: int, sh: int) -> None:
        ...
        btn_play = Button(pygame.Rect(30, hand_y - 85, 120, 48), "攻擊")
        btn_discard = Button(pygame.Rect(160, hand_y - 85, 120, 48), "棄牌")
        btn_sort_v = Button(pygame.Rect(290, hand_y - 85, 150, 48), "依照面值排序")
        btn_sort_s = Button(pygame.Rect(450, hand_y - 85, 140, 48), "依照花色排序")
        btn_back = Button(pygame.Rect(610, hand_y - 85, 160, 48), "返回地圖")
